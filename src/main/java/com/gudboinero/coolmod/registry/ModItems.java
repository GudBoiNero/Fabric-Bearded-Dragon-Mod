...
public class ModItems {
    ...
    public static final Item PRICKLY_PEAR = new Item(new Item.Settings().group(ItemGroup.FOOD).food(new FoodComponent.Builder().hunger(7).saturationModifier(0.4f).build()));
    ...
    public static final Item BLOWGUN = new BlowgunItem(ToolMaterials.IRON,
            new Item.Settings().group(ItemGroup.COMBAT).maxCount(1).maxDamage(350),15.0f);
