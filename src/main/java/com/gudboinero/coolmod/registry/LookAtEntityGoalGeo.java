...
public class LookAtEntityGoalGeo extends Goal {
    ...
    public LookAtEntityGoalGeo(MobEntity mob, Class<? extends LivingEntity> targetType, float range) {
        this(mob, targetType, range, 0.02F);
    }

    public LookAtEntityGoalGeo(MobEntity mob, Class<? extends LivingEntity> targetType, float range, float chance) {
        this.mob = mob;
